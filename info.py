...
API_ID = int(environ.get('API_ID', '27480623'))
API_HASH = environ.get('API_HASH', '76746bb61cd52e2a0842def933534a10')
BOT_TOKEN = environ.get('BOT_TOKEN', "8049727855:AAG65xv27bDXaap8nMdcuDL4QvctjvdqL6M")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002669309336'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002694399477').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Radhey:Radhey@radhey.lxzme.mongodb.net/?retryWrites=true&w=majority&appName=Radhey")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME',Radhey"techvjclonefilterbot")
